...
NAV_data_path = 'Mutual Funds data/HDFC Mutual Fund.xlsx'
...
df = pd.DataFrame(index=pd.date_range('2020-06-01', '2020-08-25'))
...
sns.scatterplot(x=df.index, y='Net Asset Value',hue='sentiment',data=df).set(xlim=(datetime.datetime(2020,6,1), datetime.datetime(2020,8,25)))
plt.show()